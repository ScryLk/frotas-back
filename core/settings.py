...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-wl$1x6r15#ln4th!7=r1cr5n%22qecl4rj@%-l&z$2m8evtz)r')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Frotas API',
    'DESCRIPTION': 'API REST para gestão de frotas. Autenticação via JWT e respostas JSON com envelope de status.',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    'SERVERS': [
        {'url': os.getenv('SPECTACULAR_SERVER_URL', 'http://localhost:8000'), 'description': 'Desenvolvimento'},
    ],
    'COMPONENTS': {
        'securitySchemes': {
            'BearerAuth': {
